...
rtl.module("webassembly",["System","JS","weborworker"],function () {
  "use strict";
  var $mod = this;
  ...
  rtl.createClass(this,"TWASIHost",pas.Classes.TComponent,function () {
    ...
    this.DoStdWrite = function (Sender, aOutput) {
      if (this.FOnConsoleWrite != null) {
       ...
       else console.log("Webassembly output: ",aOutput);
    };
    this.CreateWebAssembly = function (aPath, aImportObject) {
      ...
      Result = fetch(aPath).then(fetchOK);
      return Result;
    };
    ...
    this.StartWebAssembly = function (aPath, DoRun, aBeforeStart, aAfterStart) {
      var $Self = this;
      var ImportObj = null;
      var Res = $mod.TWebAssemblyStartDescriptor.$new();
      function InitEnv(aValue) {
        ...
        if (aBeforeStart != null) DoRun = aBeforeStart($Self,$mod.TWebAssemblyStartDescriptor.$clone(Res)) && DoRun;
        if ($Self.FBeforeStart != null) $Self.FBeforeStart($Self,$mod.TWebAssemblyStartDescriptor.$clone(Res),{get: function () {
            return DoRun;
          }, set: function (v) {
            DoRun = v;
          }});
        if (DoRun) {
          ...
          if (aAfterStart != null) aAfterStart($Self,$mod.TWebAssemblyStartDescriptor.$clone(Res));
          if ($Self.FAfterStart != null) $Self.FAfterStart($Self,$mod.TWebAssemblyStartDescriptor.$clone(Res));
        };
        return Result;
      };
      ...
      this.CreateWebAssembly(aPath,ImportObj).then(InitEnv,DoFail);
    };
  });
  $mod.$implcode = function () {
...
rtl.module("wasihostapp",["System","Classes","SysUtils","BrowserApp","webassembly","wasienv"],function () {
  ...
  rtl.createClass(this,"TBrowserWASIHostApplication",pas.BrowserApp.TBrowserApplication,function () {
    ...
    this.CreateHost = function () {
      var Result = null;
      Result = pas.wasienv.TWASIHost.$create("Create$1",[null]);
      return Result;
    };
    this.Create$1 = function (aOwner) {
    ...
    this.GetInvokeArguments = function (View, ArgsP) {
      ...
      function ReadArgMethod() {
        ...
        Result = function () {
          ...
          var ResultP = 0;
          var TempObjIds = [];
          pas.System.Writeln("TJSObjectBridge Callback: JS Method Call=",aCall," Data=",aData," Code=",aCode," Args=",arguments.length," converting args for wasm...");
          Args = $Self.CreateCallbackArgs(View,arguments,rtl.arrayRef(TempObjIds));
          try {
            pas.System.Writeln("TJSObjectBridge Callback: calling Wasm...");
            ResultP = $Self.FCallbackHandler(aCall,aData,aCode,Args);
            View = $Self.getModuleMemoryDataView();
            pas.System.Writeln("TJSObjectBridge Callback: called Wasm Call=",aCall," Data=",aData," Code=",aCode," ResultP=",ResultP," getting Result...");
            Result = $Self.EatCallbackResult(View,ResultP);
            pas.System.Writeln("TJSObjectBridge Callback: Result=",Result);
          } finally {
            pas.System.Writeln("TJSObjectBridge Callback: cleaning up TempObjIds=",rtl.length(TempObjIds)," ",TempObjIds);
...
rtl.module("program",["System","browserconsole","JS","Classes","SysUtils","Web","wasienv","wasihostapp","JOB_Browser"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DoRun = function () {
      this.StartWebAssembly("WasiFetch1.wasm",true,rtl.createCallback(this,"OnBeforeStart"),null);
    };
  });
...
//# sourceMappingURL=BrowserFetch1.js.map
