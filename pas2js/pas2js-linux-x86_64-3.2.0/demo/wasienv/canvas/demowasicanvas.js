...
rtl.module("program",["System","browserconsole","BrowserApp","JS","Classes","SysUtils","Web","webassembly","Types","wasienv","wacanvas"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TMyApplication",pas.BrowserApp.TBrowserApplication,function () {
    ...
    this.InitWebAssembly = function () {
      ...
      this.FTable = new WebAssembly.Table(pas.webassembly.TJSWebAssemblyTableDescriptor.$clone(tDesc));
      ImportObj = pas.JS.New(["js",pas.JS.New(["mem",this.FMemory,"tbl",this.FTable])]);
      this.FWasiEnv.AddImports(ImportObj);
      this.CreateWebAssembly("canvasdraw.wasm",ImportObj).then(rtl.createCallback(this,"initEnv"));
    };
    this.Create$1 = function (aOwner) {
      ...
      this.FWACanvas = pas.wacanvas.TWACanvas.$create("Create$1",[this.FWasiEnv]);
      this.FWACanvas.FCanvasParent = this.GetHTMLElement("canvases");
      return this;
    };
    this.Destroy = function () {
      pas.SysUtils.FreeAndNil({p: this, get: function () {
...
//# sourceMappingURL=demowasicanvas.js.map
